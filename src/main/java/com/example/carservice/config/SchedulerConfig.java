...
public class SchedulerConfig {
    ...
    public SchedulerConfig(GpsTrackerManagerService gpsTrackerManagerService, MaintenanceScheduleService maintenanceScheduleService,
                           ClientService clientService, ProposalMessageGenerator proposalMessageGenerator, ReminderMessageGenerator reminderMessageGenerator,
                           MessageSender messageSender, Utils utils) {
    ...
    public void sendLettersWithOfferToSignUpForService() {
        ...
        messageSender.SendMessages(proposalMessageGenerator.getSimplMailMessageList(clientCarRecommendedToServiceList));
    }
}
