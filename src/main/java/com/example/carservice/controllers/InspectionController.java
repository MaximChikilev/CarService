...
public class InspectionController extends MyAbstractController<TechnicalInspection> {
    ...
    protected InspectionController(InspectionService service, ServiceWorkService serviceWorkService, @Value("${inspectionSearchFields}") String searchFields) {
    ...
    public String deleteSparePart(@RequestParam Long inspectionId,
    ...
    private void addAttributesToPagesFroAddManyEntities(Model model, Long id, int page) {
        ...
        List<ServiceWork> serviceWorkList = serviceWorkService.getAll(PageRequest.of(page, ITEMS_PER_PAGE));
