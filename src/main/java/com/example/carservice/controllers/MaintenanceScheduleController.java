...
public class MaintenanceScheduleController extends MyAbstractController<MaintenanceSchedule> {
    ...
    protected MaintenanceScheduleController(EntityService<MaintenanceSchedule> service, InspectionService inspectionService, CarService carService,
                                            ClientService clientService, @Value("${scheduleSearchFields}") String searchFields) {
