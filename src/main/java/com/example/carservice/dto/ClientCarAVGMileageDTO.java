...
public class ClientCarAVGMileageDTO {
    ...
    public ClientCarAVGMileageDTO(String firstName, String secondName, String phoneNumber, String email, String licensePlateNumber, int mileage, double avgMileage) {
