...
@Component
public class ProposalMessageGenerator
    extends AbstractMessageGenerator<ClientCarRecommendedToServiceDTO> {

  @Override
  protected String getText(ClientCarRecommendedToServiceDTO element) {
    return String.format(
        "Dear %s, It's time for your vehicle %s to get serviced. Next inspection is %s",
