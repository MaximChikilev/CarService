...
public class CarService extends EntityService<Car> {
    ...
    protected CarService(CarRepository repository, ManufacturerService manufacturerService, CarJsonManager carJsonManager) {
        super(repository);
    ...
    public boolean isCarRegisteredToInspection(ClientCarRecommendedToServiceDTO clientCarRecommendedToService){
        return ((CarRepository)repository).countByDateAndTechnicalInspectionAndCar(
                Utils.getTodayDate(),
