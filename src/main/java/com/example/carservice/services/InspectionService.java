...
public class InspectionService extends EntityService<TechnicalInspection> {
    ...
    protected InspectionService(JpaRepository<TechnicalInspection, Long> repository, ServiceWorkService serviceWorkService, TechnicalInspectionJsonManager inspectionJsonManager) {
        super(repository);
    ...
    @Override
    protected Map<String, Function<String, List<TechnicalInspection>>> setSearchFieldsAndCorrespondingMethods() {
    ...
    protected List<TechnicalInspection> loadEntityListFromJson() throws IOException {
        ...
        for (TechnicalInspection inspection : technicalInspections) {
            if (inspection.getServiceWorks() != null) {
                inspection.setServiceWorks(serviceWorkService.replacingObjectsAfterDeserializationWithReal(inspection.getServiceWorks()));
    ...
    public void deleteServiceWorkFromInspection(long swId, long inspectionId) {
        ...
        Optional<ServiceWork> optionalSw = serviceWorkList.stream()
