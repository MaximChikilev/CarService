...
public class ServiceWorkService extends EntityService<ServiceWork> {
    ...
    protected ServiceWorkService(ServiceWorkRepository repository, SparePartService sparePartService, ServiceWorkJsonManager serviceWorkJsonManager) {
        super(repository);
    ...
    protected List<ServiceWork> loadEntityListFromJson() throws IOException {
        ...
        for (ServiceWork serviceWork :serviceWorks){
            if(serviceWork.getSpareParts()!=null){
                serviceWork.setSpareParts(sparePartService.replacingObjectsAfterDeserializationWithReal(serviceWork.getSpareParts()));
            }
        }
        return serviceWorks;
    }
    ...
    public List<ServiceWork> replacingObjectsAfterDeserializationWithReal(List<ServiceWork> inputList){
